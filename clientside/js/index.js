...
async function getProducts() {
    const res=await fetch("http://localhost:3001/api/getproducts",{headers:{
    ...
    if(res.status==200){
        ...
        const res1=await fetch(`http://localhost:3001/api/getubookings/${result.id}`);
...
async function wish(e){
    a=document.getElementById(`${e}`).src==="http://localhost:3001/images/favorite_24dp_000000_FILL0_wght400_GRAD0_opsz24.png"?"./images/favorite_24dp_EA3323_FILL1_wght400_GRAD0_opsz24.png":"./images/favorite_24dp_000000_FILL0_wght400_GRAD0_opsz24.png"; 
    document.getElementById(`${e}`).src=a;
    if (a!="./images/favorite_24dp_000000_FILL0_wght400_GRAD0_opsz24.png") {
        const res=await fetch(`http://localhost:3001/api/getproduct/${e}`);
        const product=await res.json();
        fetch("http://localhost:3001/api/addwish",{
            method:"POST",
        ...
        fetch(`http://localhost:3001/api/deletewlist/${e}`,{
            method:"DELETE",
            headers:{"Content-Type":"application/json"}
          }).then((res)=>{
                if(res.status==201){
